...
export default function Footer() {
  return (
    <footer className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-10 px-4 md:px-6 lg:px-8 py-10 bg-black -shadow-2xl max-w-[1920px] shadow-[-1px_-14px_76px_24px_rgba(0,0,0,0.6)] mt-20">
